...
/**
 *  If `YES` then the `barColor` will be the same as the `tintColor` and changes to the `tintColor` will also change the `indicatorColor`.
 *  If `NO` then changes to `tintColor` will not change the `indicatorColor`.
 *  The default is `YES`
 *  @see barColor
 *  @see tintColor
 */
